...
export const controlClass =
  "w-full rounded-control border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-[var(--shadow-input-inset)] outline-none transition-[border-color,box-shadow] duration-150 placeholder:text-slate-400 focus:border-primary focus:shadow-none focus:ring-[3px] focus:ring-primary-soft disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-500 aria-invalid:border-danger aria-invalid:focus:border-danger aria-invalid:focus:ring-danger-soft";
